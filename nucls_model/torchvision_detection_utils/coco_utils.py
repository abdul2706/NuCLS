...
import nucls_model.torchvision_detection_utils.transforms as T
import nucls_model.torchvision_detection_utils.transforms as tvdt
from nucls_model.DataLoadingUtils import _crop_all_to_fov
...
def get_coco_api_from_dataset(dataset, crop_inference_to_fov=False):
    for _ in range(10):
