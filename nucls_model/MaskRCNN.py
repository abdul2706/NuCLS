...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 image_mean=None, image_std=None, densify_mask=False,
                 # RPN parameters
        ...
        if mask_predictor is None:
            ...
            # Mohamed: if not batched_nms, just one mask per object
            n_mask_classes = num_classes if batched_nms else 2
            mask_predictor = MaskRCNNPredictor(
                mask_predictor_in_channels, mask_dim_reduced, n_mask_classes)
        ...
        super(MaskRCNN, self).__init__(
            ...
            fc_classif_dropout=fc_classif_dropout,
            cconvhead=cconvhead,
        ...
        # maybe return one dense mask for space efficiency (in inference)
        self.transform.densify_mask = densify_mask
...
def maskrcnn_resnet50_fpn(pretrained=False, progress=True, num_classes=91, pretrained_backbone=True, trainable_backbone_layers=3, **kwargs):
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.maskrcnn_resnet50_fpn(pretrained=True)  # noqa
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
